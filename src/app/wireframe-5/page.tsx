...
const items = [
  ...
  {
    title: "Karcher K5 Premium Smart",
    price: 25,
    rating: 4.8,
    tag: "95% Great",
    image: "https://picsum.photos/seed/washer/400/300",
  },
  {
  ...
  {
    title: "Red Paddle Board",
    price: 30,
    rating: 4.8,
    tag: "95% Verified",
    image: "https://picsum.photos/seed/paddle/400/300",
  },
];
      ...
      <div className="flex-1">
        ...
        <main className="p-8">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Showing 124 results in Greenpoint, Brooklyn
              </p>
            </div>
          ...
          <div className="flex justify-center mt-10">
            <button className="bg-green-600 text-white px-6 py-2 rounded-full shadow-md">
              View Map
            </button>
          </div>
