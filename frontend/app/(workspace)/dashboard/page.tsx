...
export default function DashboardPage() {
  ...
  try {
    ...
    console.log("Dashboard listings response count:", listingsData.length);
    const mapped = listingsData.map((item: any) => {
      ...
      try {
        console.log("User listing image mapping:", { id: item._id ?? item.id, name: item.name ?? item.title, resolved: imageSrc });
      } catch (e) {}
