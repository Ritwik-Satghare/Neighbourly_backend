...
export function ListingCard({
  ...
  return (
    <div
      onClick={onClick}
      className="group block w-full h-full rounded-xl bg-white p-4 shadow-sm transition duration-300 hover:-translate-y-1 cursor-pointer"
    >
        ...
        <div className="mt-3 flex flex-grow flex-col">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              <h3 className="font-headline text-lg font-bold text-ink-strong">
                {listing.title}
              </h3>
