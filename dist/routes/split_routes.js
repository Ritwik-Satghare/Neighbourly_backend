...
const splitController = __importStar(require("../controllers/split_controller"));
...
router.post('/create', (0, validation_middleware_1.validateRequest)(splitController.createSplitSchema), splitController.createSplit);
...
// Body: { bookingID }
router.post('/pay', (0, validation_middleware_1.validateRequest)(splitController.payShareSchema), splitController.payShare);
