...
exports.getMessages = exports.sendMessage = exports.sendMessageSchema = void 0;
...
const sendMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const message = yield messageService.sendMessage(conversationID, userID, content);
        res.status(201).json({
            success: true,
...
const getMessages = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (limit > 100)
            limit = 100;
        const result = yield messageService.getMessages(conversationID, userID, page, limit);
        res.status(200).json({
            success: true,
