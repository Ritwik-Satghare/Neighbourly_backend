...
exports.getReviewsByUser = exports.getReviewsByListing = exports.createReview = exports.createReviewSchema = void 0;
const reviewService = __importStar(require("../services/review_service"));
...
const createReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const review = yield reviewService.createReview(userID, listingID, rating, comment);
        res.status(201).json({
            success: true,
...
const getReviewsByListing = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { listingID } = req.params;
        const reviews = yield reviewService.getReviewsByListing(listingID);
        res.status(200).json({
            success: true,
...
const getReviewsByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const reviews = yield reviewService.getReviewsByUser(userID);
        res.status(200).json({
            success: true,
            message: 'Reviews fetched successfully',
            data: reviews,
